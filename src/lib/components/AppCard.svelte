...
<div class="group bg-card border border-border rounded-xl p-5 flex flex-col h-full transition-all duration-150 hover:bg-secondary/40 dark:hover:bg-secondary/20 animate-fade-in shadow-sm">
	<div class="flex items-start gap-4 mb-4">
		<div class="size-12 rounded-xl bg-muted flex items-center justify-center overflow-hidden border border-border shrink-0 shadow-inner">
			{#if app.logo_url}
